...
if __name__ == '__main__':
    ...
    parser.add_argument('--symbol', type=str, help='Market Symbol (Ex: XVGBTC - XVGETH)', default='NANOETH')
    parser.add_argument('--profit', type=float, help='Target Profit', default=0.5)
    parser.add_argument('--amount', type=float, help='Buy/Sell BTC Amount (Ex: 0.002 BTC', default=0.058)
    parser.add_argument('--max_amount', type=bool, help='Buy/Sell with max BTC amount True/False', default=False)

    parser.add_argument('--stop_loss', type=float, help='Target Stop-Loss % (If the price drops by 6%, sell market_price.)', default=0.7) 

    parser.add_argument('--increasing', type=float, help='Buy Price +Increasing 0.2%', default=0.05)
    parser.add_argument('--decreasing', type=float, help='Sell Price -Decreasing 0.2%', default=0.05)
